...
################################################################################
## Form generated from reading UI file 'restore_mnemo.ui'
##
...
"border: 5px solid rgba(255,255,255,40);")
        ...
        self.ok_btn.setGeometry(QRect(430, 290, 75, 41))
        font1 = QFont()
...
"}")
        ...
        self.pk_label.setGeometry(QRect(40, 160, 871, 81))
        font2 = QFont()
...
"")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"Warthog Network:mnemo", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"Enter mnemonic phrase here:", None))
